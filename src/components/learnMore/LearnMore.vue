...
@media screen and (min-width: 440px) and (max-width: 648px) {
...
@media screen and (min-width: 649px) and (max-width: 1040px) {
  .contenedor{
    padding-right: 2%;
    padding-left: 2%;
    margin-bottom: 0px;
